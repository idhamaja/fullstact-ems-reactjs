...
const Sidebar = () => {
  ...
  const sidebarContent = (
    // ✅ flex flex-col h-full agar logout bisa sticky di bawah
    <div className="flex flex-col h-full">
      ...
      {/* ✅ Nav Items — flex-1 agar mendorong logout ke bawah */}
      <div className="flex-1 px-3 space-y-0.5 overflow-y-auto">
        {loading ? (
          ...
          // ✅ Hanya satu kali map, tidak duplikat
      ...
      {/* ✅ Logout — selalu di bawah, tidak ikut scroll */}
